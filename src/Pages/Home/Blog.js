        ...
        <div className='md:px-24 max-h-fit my-5'>
            <div className="card w-full bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <h2 className="card-title">4.  Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts.</h2>
                    ...
                    <h2 className="card-title">6. What is a unit test? Why should write unit tests?</h2>
